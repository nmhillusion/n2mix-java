...
public abstract class DateUtil {
    ...
    public static LocalDate buildDateFromString(String day, String month, String year) {
        try {
            ...
            getLogger(DateUtil.class).error(ex);
            return null;
        }
    }
    ...
    public static String format(Date date, String datePattern) {
        ...
        try {
            if (null != date) {
                final SimpleDateFormat dateFormatter_ = new SimpleDateFormat(datePattern);
                formattedDate = dateFormatter_.format(date);
            }
        } catch (Exception ex) {
            getLogger(DateUtil.class).error(ex);
        }
