package app.netlify.nmhillusion.n2mix.validator;
...
import static app.netlify.nmhillusion.n2mix.type.FunctionalFactory.not;
...
class StringValidatorTest {
    ...
    void testStream() {
        final String[] filteredList = new ArrayList<String>(Arrays.asList("45", null, "hello", "", "   ", "equipment"))
                .stream()
                .filter(not(StringValidator::isBlank))
                .map(String::trim)
                .toArray(String[]::new);
